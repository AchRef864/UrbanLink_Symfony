...
class __TwigTemplate_dad0bffe0327a8b157ce3b215ce3004f extends Template
{
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["reponse"]) {
            ...
            yield "</span>
                                ...
                                <td class=\"p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent\">
                                    <span class=\"leading-tight text-xs text-slate-400\">";
            // line 34
            yield ((CoreExtension::getAttribute($this->env, $this->source, $context["reponse"], "dateReponse", [], "any", false, false, false, 34)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, $context["reponse"], "dateReponse", [], "any", false, false, false, 34), "Y-m-d"), "html", null, true)) : (""));
            yield "</span>
                                </td>
                                <td class=\"p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent\">
                                    <span class=\"leading-tight text-xs text-slate-400\">";
