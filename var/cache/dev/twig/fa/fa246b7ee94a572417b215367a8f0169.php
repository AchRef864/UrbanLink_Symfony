...
class __TwigTemplate_fdf39f9716d991d490b77b1b20ba071e extends Template
{
...
<body>
    <div class=\"container\">
        ...
        yield "\" method=\"POST\" enctype=\"multipart/form-data\">
                    ...
                    <div class=\"form-grid\">
                        ...
                        <div class=\"form-group\">
                            ...
                            <input type=\"number\" name=\"seats\" id=\"seats\" class=\"form-control\" value=\"5\" min=\"1\" max=\"50\">
                            <div class=\"input-icon\">
                                <svg xmlns=\"http://www.w3.org/2000/svg\" width=\"18\" height=\"18\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\">
        ...
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["drivers"]) || array_key_exists("drivers", $context) ? $context["drivers"] : (function () { throw new RuntimeError('Variable "drivers" does not exist.', 653, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["driver"]) {
            // line 654
            yield "                                    <option value=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["driver"], "id", [], "any", false, false, false, 654), "html", null, true);
            yield "\">";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["driver"], "name", [], "any", false, false, false, 654), "html", null, true);
            yield "</option>
                                ";
        }
...
";
    ...
    {
        return array (  811 => 698,  767 => 656,  756 => 654,  752 => 653,  643 => 547,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
