...
/* base.html.twig */
class __TwigTemplate_84207bfcf600cb149adf5b62e982d880 extends Template
{
      ...
      <ul class=\"sidebar-menu\">
        ...
        <li>
          <a href=\"";
            ...
            yield "\">
            <i class=\"fas fa-comment-dots\"></i> Rate
          </a>
        </li>
        ...
        <li>
          ...
          <a href=\"";
            ...
            yield "\" class=\"";
            yield (((is_string($_v16 = CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 337, $this->source); })()), "request", [], "any", false, false, false, 337), "get", ["_route"], "method", false, false, false, 337)) && is_string($_v17 = "abonnement_") && str_starts_with($_v16, $_v17))) ? ("active") : (""));
            yield "\">
        ...
        <li class=\"nav-item\">
          <a href=\"#\"
             ...
             class=\"nav-link ";
            // line 345
            yield (((is_string($_v18 = CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 345, $this->source); })()), "request", [], "any", false, false, false, 345), "get", ["_route"], "method", false, false, false, 345)) && is_string($_v19 = "urbantalk_") && str_starts_with($_v18, $_v19))) ? ("active") : (""));
            yield "\">
        ...
        <li>
          <a href=\"";
            ...
            yield "\" class=\"";
            yield (((is_string($_v20 = CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 354, $this->source); })()), "request", [], "any", false, false, false, 354), "get", ["_route"], "method", false, false, false, 354)) && is_string($_v21 = "admin_user_") && str_starts_with($_v20, $_v21))) ? ("active") : (""));
            yield "\">
        ...
        <li>
          <a href=\"";
            ...
            yield "\" class=\"";
            yield (((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 359, $this->source); })()), "request", [], "any", false, false, false, 359), "get", ["_route"], "method", false, false, false, 359) == "admin_user_delete")) ? ("active") : (""));
            yield "\">
        ...
        <li>
          <a href=\"";
            ...
            yield "\" class=\"";
            yield (((is_string($_v22 = CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 364, $this->source); })()), "request", [], "any", false, false, false, 364), "get", ["_route"], "method", false, false, false, 364)) && is_string($_v23 = "course_") && str_starts_with($_v22, $_v23))) ? ("active") : (""));
            yield "\">
        ...
        <li>
          <a href=\"";
            ...
            yield "\" class=\"";
            yield (((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 369, $this->source); })()), "request", [], "any", false, false, false, 369), "get", ["_route"], "method", false, false, false, 369) == "course_map")) ? ("active") : (""));
            yield "\">
        ...
        <li>
          <a href=\"";
            ...
            yield "\" class=\"";
            yield (((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 374, $this->source); })()), "request", [], "any", false, false, false, 374), "get", ["_route"], "method", false, false, false, 374) == "admin_statistics")) ? ("active") : (""));
            yield "\">
        ...
        <li>
          <a href=\"";
            // line 379
            yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_pdf_generator");
            yield "\" class=\"";
            yield (((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 379, $this->source); })()), "request", [], "any", false, false, false, 379), "get", ["_route"], "method", false, false, false, 379) == "admin_pdf_generator")) ? ("active") : (""));
            yield "\">
            <i class=\"fas fa-file-pdf\"></i> Generates PDF
          </a>
        </li>
        ...
        <li>
          <a href=\"";
            ...
            yield "\" class=\"";
            yield (((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 387, $this->source); })()), "request", [], "any", false, false, false, 387), "get", ["_route"], "method", false, false, false, 387) == "app_profile_edit")) ? ("active") : (""));
            yield "\">
...
";
        // line 402
        if ( !(isset($context["is_auth_page"]) || array_key_exists("is_auth_page", $context) ? $context["is_auth_page"] : (function () { throw new RuntimeError('Variable "is_auth_page" does not exist.', 402, $this->source); })())) {
            // line 403
            yield "  <nav>
    <div class=\"container\">
...
";
    ...
    {
        return array (  878 => 518,  865 => 517,  843 => 500,  609 => 41,  596 => 40,  573 => 17,  558 => 558,  555 => 557,  550 => 554,  547 => 553,  545 => 517,  540 => 515,  537 => 513,  532 => 511,  528 => 510,  523 => 509,  521 => 508,  517 => 505,  512 => 501,  510 => 500,  506 => 498,  503 => 496,  498 => 493,  488 => 486,  478 => 478,  476 => 477,  466 => 470,  463 => 469,  450 => 457,  443 => 452,  439 => 451,  432 => 446,  425 => 441,  421 => 440,  414 => 435,  407 => 430,  403 => 429,  396 => 424,  382 => 411,  378 => 408,  375 => 407,  370 => 403,  368 => 402,  365 => 400,  354 => 392,  344 => 387,  331 => 379,  321 => 374,  311 => 369,  301 => 364,  291 => 359,  281 => 354,  269 => 345,  256 => 337,  247 => 333,  237 => 328,  228 => 324,  217 => 318,  201 => 307,  190 => 301,  179 => 295,  168 => 289,  154 => 280,  145 => 274,  141 => 272,  139 => 271,  136 => 269,  134 => 268,  128 => 266,  125 => 265,  122 => 40,  116 => 37,  110 => 34,  105 => 31,  100 => 30,  89 => 20,  84 => 17,  77 => 13,  73 => 12,  69 => 11,  65 => 10,  60 => 9,  52 => 2,);
    }
  ...
  <aside class=\"argon-sidebar\">
    ...
    <div class=\"sidebar-content\">
      <ul class=\"sidebar-menu\">
        ...
        <li>
          <a href=\"{{ path('admin_pdf_generator') }}\" class=\"{{ app.request.get('_route') == 'admin_pdf_generator' ? 'active' : '' }}\">
            <i class=\"fas fa-file-pdf\"></i> Generates PDF
          </a>
        </li>
        ...
        <li>
          <a href=\"{{ path('app_logout') }}\" class=\"text-red-500\">
            <i class=\"fas fa-sign-out-alt\"></i> Logout
          </a>
        </li>
      </ul>
...
</html>", "base.html.twig", "C:\\Users\\skonb\\Desktop\\UrbanLink_Symfony1\\templates\\base.html.twig");
    }
}
