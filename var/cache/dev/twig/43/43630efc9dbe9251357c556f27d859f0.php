...
class __TwigTemplate_9906c242c3a8d0bfaab1d1579e898265 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $this->parent = $this->loadTemplate("base.html.twig", "dashboard/taxi.html.twig", 2);
...
";
    ...
    <aside class=\"sidebar fixed inset-y-0 left-0 z-40 flex-wrap items-center justify-between block w-full p-0 my-4 overflow-y-auto bg-white border-0 shadow-xl max-w-64 ease-nav-brand\">
        ...
        yield "\">
                <span class=\"ml-1 font-semibold transition-all duration-200 ease-nav-brand\">Taxi Panel</span>
            </a>
        </div>
...
";
    ...
    {
        return array (  311 => 171,  261 => 124,  250 => 116,  239 => 108,  226 => 98,  203 => 77,  190 => 76,  116 => 12,  112 => 11,  108 => 10,  101 => 7,  88 => 6,  65 => 4,  42 => 2,);
    }
...
{% block body %}
    ...
    <aside class=\"sidebar fixed inset-y-0 left-0 z-40 flex-wrap items-center justify-between block w-full p-0 my-4 overflow-y-auto bg-white border-0 shadow-xl max-w-64 ease-nav-brand\">
        <div class=\"h-19\">
            <i class=\"absolute top-4 right-4 p-1 opacity-50 cursor-pointer fas fa-times text-slate-400 lg:hidden sidenav-close\"></i>
            <a class=\"block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700\" href=\"{{ path('taxi_dashboard') }}\">
                <span class=\"ml-1 font-semibold transition-all duration-200 ease-nav-brand\">Taxi Panel</span>
            </a>
        </div>
        ...
        <div class=\"items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full\">
            <ul class=\"flex flex-col pl-0 mb-0\">
                <li class=\"mt-0.5 w-full\">
                    <a class=\"py-2.7 bg-blue-500/13 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 font-semibold text-slate-700 transition-colors\" href=\"{{ path('taxi_dashboard') }}\">
                        <div class=\"mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5\">
                            <i class=\"fas fa-tachometer-alt text-blue-500\"></i>
                        </div>
                        <span class=\"ml-1 duration-300 opacity-100 pointer-events-none ease\">Dashboard</span>
...
{% endblock %}", "dashboard/taxi.html.twig", "C:\\Users\\PC\\OneDrive\\Documents\\GitHub\\UrbanLInk_Symfony\\UrbanLink_Symfony\\templates\\dashboard\\taxi.html.twig");
    }
}
