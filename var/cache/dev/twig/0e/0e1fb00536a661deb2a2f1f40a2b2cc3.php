...
class __TwigTemplate_dae250aaa1efcab4ef01e47f334fae51 extends Template
{
    ...
    {
        // line 1
        return $this->loadTemplate(((array_key_exists("base_template", $context)) ? ((isset($context["base_template"]) || array_key_exists("base_template", $context) ? $context["base_template"] : (function () { throw new RuntimeError('Variable "base_template" does not exist.', 1, $this->source); })())) : ("base.html.twig")), "vehicle/new.html.twig", 1);
    }
...
<body>
    <div class=\"container\">
        ...
        yield "                            <div class=\"vehicle-type-card\" data-type=\"Minibus\" onclick=\"selectVehicleType(this)\">
                    ...
                    <div class=\"form-grid\">
                        ...
                        <div class=\"form-group\">
                            ...
                            <input type=\"number\" name=\"year\" id=\"year\" class=\"form-control\" value=\"2023\" min=\"1900\" max=\"2025\">
                            <div class=\"input-icon\">
                                <svg xmlns=\"http://www.w3.org/2000/svg\" width=\"18\" height=\"18\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\">
        ...
        if ($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_ADMIN")) {
            ...
            $context['_seq'] = CoreExtension::ensureTraversable((isset($context["drivers"]) || array_key_exists("drivers", $context) ? $context["drivers"] : (function () { throw new RuntimeError('Variable "drivers" does not exist.', 660, $this->source); })()));
            foreach ($context['_seq'] as $context["_key"] => $context["driver"]) {
                // line 661
                yield "                                        <option value=\"";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["driver"], "id", [], "any", false, false, false, 661), "html", null, true);
                yield "\">";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["driver"], "name", [], "any", false, false, false, 661), "html", null, true);
                yield "</option>
                                    ";
            }
...
document.getElementById('vehicleForm').addEventListener('submit', function(e) {
    ...
    if (yearInput.value < 1900 || yearInput.value > new Date().getFullYear() + 1) {
        showError(yearInput, `Please enter a valid year between 1900 and \${new Date().getFullYear() + 1}`);
        isValid = false;
    }
    
    // Validate seats
    const seatsInput = document.getElementById('seats');
    if (seatsInput.value < 1 || seatsInputInput.value > 50) {
        showError(seatsInput, 'Please enter a valid number of seats (1-50)');
        isValid = false;
    }
...
";
    ...
    {
        return array (  863 => 724,  851 => 716,  839 => 708,  837 => 707,  800 => 672,  789 => 663,  778 => 661,  774 => 660,  768 => 656,  766 => 655,  678 => 569,  671 => 564,  669 => 563,  656 => 552,  650 => 550,  644 => 548,  642 => 547,  99 => 6,  86 => 5,  63 => 3,  41 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("{% extends base_template is defined ? base_template : 'base.html.twig' %}
...
{% endblock %}
", "vehicle/new.html.twig", "C:\\Users\\PC\\OneDrive\\Documents\\GitHub\\UrbanLInk_Symfony\\UrbanLink_Symfony\\templates\\vehicle\\new.html.twig");
    }
}
