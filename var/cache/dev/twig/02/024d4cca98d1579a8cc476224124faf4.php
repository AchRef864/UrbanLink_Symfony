...
/* admin/pdf.html.twig */
class __TwigTemplate_12c6fe737faf8fcd906346ebb060a1c1 extends Template
{
...
<table>
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            ...
            <td class=\"status-";
            // line 50
            if (CoreExtension::getAttribute($this->env, $this->source, $context["user"], "isBlocked", [], "any", false, false, false, 50)) {
                yield "blocked";
            } else {
                yield "active";
            }
            yield "\">
                ";
            // line 51
            if (CoreExtension::getAttribute($this->env, $this->source, $context["user"], "isBlocked", [], "any", false, false, false, 51)) {
                yield "Blocked";
            } else {
                yield "Active";
            }
...
</html>", "admin/pdf.html.twig", "C:\\Users\\PC\\OneDrive\\Documents\\GitHub\\UrbanLInk_Symfony\\UrbanLink_Symfony\\templates\\admin\\pdf.html.twig");
    }
}
