...
class __TwigTemplate_267c57e345d6430d53280dd2bdd471a8 extends Template
{
...
{% block scripts %}
    <script src=\"{{ asset('assets/js/plugins/perfect-scrollbar.min.js') }}\"></script>
    <script src=\"{{ asset('assets/js/argon-dashboard-tailwind.js') }}\"></script>
{% endblock %}", "admin/users/edit.html.twig", "C:\\Users\\moham\\Downloads\\UrbanLInkfinal\\templates\\admin\\users\\edit.html.twig");
    }
}
