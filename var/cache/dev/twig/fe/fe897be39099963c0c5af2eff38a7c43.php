...
class __TwigTemplate_29e393923419a9fa9bca0b3581027541 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $this->parent = $this->loadTemplate("base.html.twig", "dashboard/client.html.twig", 2);
...
";
    ...
    <aside class=\"sidebar fixed inset-y-0 left-0 z-40 flex-wrap items-center justify-between block w-full p-0 my-4 overflow-y-auto bg-white border-0 shadow-xl max-w-64 ease-nav-brand\">
        ...
        yield "\">
                <span class=\"ml-1 font-semibold transition-all duration-200 ease-nav-brand\">Client Panel</span>
            </a>
        </div>
    ...
    <main class=\"relative h-full max-height-screen transition-all duration-200 ease-in-out xl:ml-68 rounded-xl\">
        ...
        // line 162
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 162, $this->source); })()), "user", [], "any", false, false, false, 162), "name", [], "any", false, false, false, 162), "html", null, true);
        yield "</p>
                </nav>
            </div>
        </nav>
        ...
        if ($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_CLIENT")) {
            ...
            // line 180
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 180, $this->source); })()), "email", [], "any", false, false, false, 180), "html", null, true);
            yield "</p>
                                </div>
                            </div>
                            <div class=\"flex items-center p-4 bg-gray-50 rounded-lg\">
                                ...
                                <div>
                                    ...
                                    <p class=\"font-semibold\">";
            // line 189
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 189, $this->source); })()), "phone", [], "any", false, false, false, 189), "html", null, true);
            yield "</p>
                                </div>
                            </div>
                            <div class=\"flex items-center p-4 bg-gray-50 rounded-lg\">
...
";
    ...
    {
        return array (  381 => 221,  371 => 213,  362 => 207,  341 => 189,  329 => 180,  317 => 170,  315 => 169,  305 => 162,  282 => 142,  268 => 131,  256 => 122,  245 => 114,  232 => 104,  209 => 83,  196 => 82,  116 => 12,  112 => 11,  108 => 10,  101 => 7,  88 => 6,  65 => 4,  42 => 2,);
    }
...
{% block body %}
    ...
    <aside class=\"sidebar fixed inset-y-0 left-0 z-40 flex-wrap items-center justify-between block w-full p-0 my-4 overflow-y-auto bg-white border-0 shadow-xl max-w-64 ease-nav-brand\">
        <div class=\"h-19\">
            <i class=\"absolute top-4 right-4 p-1 opacity-50 cursor-pointer fas fa-times text-slate-400 lg:hidden sidenav-close\"></i>
            <a class=\"block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700\" href=\"{{ path('client_dashboard') }}\">
                <span class=\"ml-1 font-semibold transition-all duration-200 ease-nav-brand\">Client Panel</span>
            </a>
        </div>
        ...
        <div class=\"items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full\">
            <ul class=\"flex flex-col pl-0 mb-0\">
                <li class=\"mt-0.5 w-full\">
                    <a class=\"py-2.7 bg-blue-500/13 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 font-semibold text-slate-700 transition-colors\" href=\"{{ path('client_dashboard') }}\">
                        <div class=\"mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5\">
                            <i class=\"fas fa-tachometer-alt text-blue-500\"></i>
                        </div>
                        <span class=\"ml-1 duration-300 opacity-100 pointer-events-none ease\">Dashboard</span>
                ...
                <li class=\"mt-0.5 w-full\">
                    <a class=\"py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 font-semibold text-slate-700 transition-colors\" href=\"{{ path('app_profile') }}\">
                        <div class=\"mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5\">
                            <i class=\"fas fa-user text-amber-500\"></i>
                        </div>
                        <span class=\"ml-1 duration-300 opacity-100 pointer-events-none ease\">My Profile</span>
...
{% endblock %}", "dashboard/client.html.twig", "C:\\Users\\PC\\OneDrive\\Documents\\GitHub\\UrbanLInk_Symfony\\UrbanLink_Symfony\\templates\\dashboard\\client.html.twig");
    }
}
