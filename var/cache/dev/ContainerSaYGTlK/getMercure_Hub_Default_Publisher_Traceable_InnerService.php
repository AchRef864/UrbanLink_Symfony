...
class getMercure_Hub_Default_Publisher_Traceable_InnerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return new \Symfony\Component\Mercure\Publisher($container->getEnv('MERCURE_URL'), ($container->privates['mercure.hub.default.jwt.provider'] ?? self::getMercure_Hub_Default_Jwt_ProviderService($container)), ($container->privates['.debug.http_client'] ?? self::get_Debug_HttpClientService($container)));
    }
}
