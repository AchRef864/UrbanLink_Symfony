...
class Vehicle extends \App\Entity\Vehicle implements \Doctrine\ORM\Proxy\InternalProxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        "\0".parent::class."\0".'airConditioning' => [parent::class, 'airConditioning', null],
        "\0".parent::class."\0".'brand' => [parent::class, 'brand', null],
        "\0".parent::class."\0".'color' => [parent::class, 'color', null],
        "\0".parent::class."\0".'driverID' => [parent::class, 'driverID', null],
        ...
        "\0".parent::class."\0".'licensePlate' => [parent::class, 'licensePlate', null],
