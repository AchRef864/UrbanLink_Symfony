...
class __TwigTemplate_022756a56eab88d1aac8763814ac8e18 extends Template
{
    ...
    <div class=\"container mx-auto px-4 py-8\">
        <div class=\"bg-white p-6 rounded-lg shadow-md text-center\">
            ...
            <h2 class=\"mt-3 text-xl font-medium text-gray-900\">Paiement réussi!</h2>
...
<div style=\"margin-left: 280px;\">
    <div class=\"container mx-auto px-4 py-8\">
        <div class=\"bg-white p-6 rounded-lg shadow-md text-center\">
            ...
            <h2 class=\"mt-3 text-xl font-medium text-gray-900\">Paiement réussi!</h2>
            <p class=\"mt-2 text-gray-600\">Votre réservation #{{ reservation.id }} a été confirmée.</p>
            <div class=\"mt-4\">
...
{% endblock %}", "reservation/success.html.twig", "C:\\Users\\skonb\\Desktop\\pi\\UrbanLink_Symfony_Fork-main\\templates\\reservation\\success.html.twig");
    }
}
