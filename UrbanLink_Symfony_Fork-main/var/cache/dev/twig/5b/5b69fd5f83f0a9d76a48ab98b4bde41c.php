...
class __TwigTemplate_3be5336985aa59af3943c7339d1a703d extends Template
{
...
<body>
    ...
    <div class=\"info-section\">
        ...
        <div class=\"info-grid\">
            ...
            <div class=\"info-item\">
                <span class=\"info-label\">Prix unitaire:</span> {{ reservation.trajet.price }} €
            </div>
        </div>
    </div>
    ...
    <div class=\"info-section\">
        ...
        <div class=\"info-grid\">
            ...
            <div class=\"info-item\">
                <span class=\"info-label\">Prix total:</span> {{ reservation.totalPrice }} €
            </div>
            <div class=\"info-item\">
                <span class=\"info-label\">Statut:</span>
...
</html>", "reservation/pdf.html.twig", "C:\\Users\\skonb\\Desktop\\pi\\UrbanLink_Symfony_Fork-main\\templates\\reservation\\pdf.html.twig");
    }
}
