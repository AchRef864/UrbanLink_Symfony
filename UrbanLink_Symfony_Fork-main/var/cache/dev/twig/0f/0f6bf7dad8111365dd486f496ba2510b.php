...
class __TwigTemplate_84fdb872eece213b2d56d00c4f6209e1 extends Template
{
    ...
    <main class=\"mt-0 transition-all duration-200 ease-in-out\">
        ...
        if ((isset($context["error"]) || array_key_exists("error", $context) ? $context["error"] : (function () { throw new RuntimeError('Variable "error" does not exist.', 64, $this->source); })())) {
            ...
            yield "                                        <div class=\"relative px-4 py-3 mb-4 text-sm text-white bg-red-500 rounded-lg\" role=\"alert\">
                                            ";
            // line 66
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["error"]) || array_key_exists("error", $context) ? $context["error"] : (function () { throw new RuntimeError('Variable "error" does not exist.', 66, $this->source); })()), "html", null, true);
            yield "
                                        </div>
                                    ";
        }
        ...
        if (CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 70, $this->source); })()), "user", [], "any", false, false, false, 70)) {
            ...
            // line 72
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 72, $this->source); })()), "user", [], "any", false, false, false, 72), "userIdentifier", [], "any", false, false, false, 72), "html", null, true);
            yield ", <a href=\"";
                                    ...
                                    <form method=\"post\" novalidate>
                                        <div class=\"mb-4\">
                                            ...
                                            <input
                                                    ...
                                                    value=\"";
        // line 81
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["last_username"]) || array_key_exists("last_username", $context) ? $context["last_username"] : (function () { throw new RuntimeError('Variable "last_username" does not exist.', 81, $this->source); })()), "html", null, true);
        yield "\"
                                                    name=\"_username\"
                                                    id=\"inputEmail\"
                                            ...
                                            ";
        // line 87
        if ((array_key_exists("form_errors", $context) && CoreExtension::getAttribute($this->env, $this->source, ($context["form_errors"] ?? null), "_username", [], "array", true, true, false, 87))) {
            // line 88
            yield "                                                <div class=\"text-red-500 text-xs mt-1\">";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form_errors"]) || array_key_exists("form_errors", $context) ? $context["form_errors"] : (function () { throw new RuntimeError('Variable "form_errors" does not exist.', 88, $this->source); })()), "_username", [], "array", false, false, false, 88), "html", null, true);
            yield "</div>
                                            ";
        }
        // line 90
        yield "                                        </div>
                                        ...
                                        <div class=\"mb-4\">
                                            ...
                                            ";
        // line 101
        if ((array_key_exists("form_errors", $context) && CoreExtension::getAttribute($this->env, $this->source, ($context["form_errors"] ?? null), "_password", [], "array", true, true, false, 101))) {
            // line 102
            yield "                                                <div class=\"text-red-500 text-xs mt-1\">";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form_errors"]) || array_key_exists("form_errors", $context) ? $context["form_errors"] : (function () { throw new RuntimeError('Variable "form_errors" does not exist.', 102, $this->source); })()), "_password", [], "array", false, false, false, 102), "html", null, true);
            yield "</div>
                                            ";
        }
        // line 104
...
";
    ...
    {
        return array (  381 => 166,  377 => 165,  371 => 163,  358 => 162,  318 => 132,  309 => 126,  302 => 122,  283 => 106,  279 => 104,  273 => 102,  271 => 101,  258 => 90,  252 => 88,  250 => 87,  241 => 81,  233 => 75,  225 => 72,  222 => 71,  220 => 70,  217 => 69,  211 => 66,  208 => 65,  206 => 64,  177 => 38,  168 => 32,  159 => 26,  155 => 25,  147 => 19,  134 => 18,  121 => 15,  117 => 14,  113 => 13,  106 => 9,  102 => 7,  89 => 6,  66 => 4,  43 => 2,);
    }
...
{% endblock %}", "auth/login/login.html.twig", "C:\\Users\\skonb\\Desktop\\pi\\UrbanLink_Symfony_Fork-main\\templates\\auth\\login\\login.html.twig");
    }
}
