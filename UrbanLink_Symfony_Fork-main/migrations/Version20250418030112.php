 ...
 */
final class Version20250418030112 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE abonnement (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(255) NOT NULL, prix DOUBLE PRECISION NOT NULL, date_debut DATE NOT NULL, date_fin DATE NOT NULL, etat VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE abonnement_reservation (id INT AUTO_INCREMENT NOT NULL, abonnement_id INT NOT NULL, user_id INT NOT NULL, fullname VARCHAR(255) DEFAULT NULL, statut VARCHAR(255) NOT NULL, date_debut DATE NOT NULL, date_fin DATE NOT NULL, reference VARCHAR(8) NOT NULL, UNIQUE INDEX UNIQ_B4E3A574AEA34913 (reference), INDEX IDX_B4E3A574F1D74413 (abonnement_id), INDEX IDX_B4E3A574A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE abonnement_reservation ADD CONSTRAINT FK_B4E3A574F1D74413 FOREIGN KEY (abonnement_id) REFERENCES abonnement (id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE abonnement_reservation ADD CONSTRAINT FK_B4E3A574A76ED395 FOREIGN KEY (user_id) REFERENCES users (user_id)
        SQL);
